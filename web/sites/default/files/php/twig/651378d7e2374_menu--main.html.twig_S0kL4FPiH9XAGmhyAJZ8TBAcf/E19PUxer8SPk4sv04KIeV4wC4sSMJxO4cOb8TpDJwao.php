...
class __TwigTemplate_4c9f6b5b2f28a7958f48fd129138be13 extends Template
{
    private $source;
    private $macros = [];
...
($context["menu_level"] ?? null) == 1) && twig_get_attribute($this->env, $this->source, $context["item"], "is_expanded", [], "any", false, false, true, 47))) {
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/dxpr_theme/templates/menu--main.html.twig", "/var/www/html/dxpr/d10gammaalpha/web/themes/contrib/dxpr_theme/templates/menu--main.html.twig");
    }
